...
struct drm_i915_gem_exec_object2 *i915_batchbuf_add_to_cache(struct batchbuffer *bb, 
                                                             uint32_t handle);
struct drm_i915_gem_exec_object2 *i915_batchbuf_add_object(struct batchbuffer *bb,
                                                           uint32_t handle, 
                                                           uint64_t size, 
                                                           uint64_t offset, 
                                                           uint64_t alignment, 
...
struct drm_i915_gem_exec_object2 *i915_batchbuf_add_buff(struct batchbuffer *bb,
							 ...
							 uint64_t alignment,
							 bool write);
struct drm_i915_gem_exec_object2 *i915_batchbuf_find_object(struct batchbuffer *bb, 
                                                            uint32_t handle);
...
static void i915_batchbuf_update_offsets(struct batchbuffer *bb,
			                 struct drm_i915_gem_exec_object2 *objects);
