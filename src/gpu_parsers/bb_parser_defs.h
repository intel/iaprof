...
#define STATE_COMPUTE_MODE OP_GFXPIPE(0x0, 0x1, 0x5)
#define STATE_COMPUTE_MODE_DWORDS 2
...
#define CFE_STATE_DWORDS 6

#define _3DSTATE_BINDING_TABLE_POOL_ALLOC OP_GFXPIPE(0x3, 0x1, 0x19)
#define _3DSTATE_BINDING_TABLE_POOL_ALLOC_DWORDS 4
